...
class PagesPublication implements iPublicationProcessor {
  ...
  public function processPublication(
    ...
    try {
      ...
      foreach ($contents as $content) {
        ...
        if (!empty($mappedDateString) && (($starttime > 0 && $starttime < $currentTime) || ($endtime > 0 && $endtime < $currentTime))) {
